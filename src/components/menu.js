    ...
    <div className={menuStyles.wrapper}>
        ...
        <div className={menuStyles.column2}>
          ...
          <div className={menuStyles.linkContainer}>
            ...
            <div className={menuStyles.linkList}>
              <ol>
                <li>
                  <button className={menuStyles.menubtn} onClick={() => scrollTo('#events')}>Events</button>
                </li>
                <li>
                  <button className={menuStyles.menubtn} onClick={() => scrollTo('#featured')} >Featured Artists</button>
                </li>
                <li> 
                  <button className={menuStyles.menubtn} onClick={() => scrollTo('#callout')} >Artist Callout</button>
                </li>
                <li>
                    <button className={menuStyles.menubtn} onClick={() => scrollTo('#about')} >About</button>
                </li>
                <li> 
                    <button  className={menuStyles.menubtn} onClick={() => scrollTo('#support')} >Support </button>
                </li>
              </ol>
            </div>
          </div>  
