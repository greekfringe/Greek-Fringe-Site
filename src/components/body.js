    ...
    <div id="top" className={bodyStyles.wrapper}>
      ...
      <div className={bodyStyles.body}>
        ...
        <div className={bodyStyles.events}>
          ...
          <h3>
            Greek Fringe is all about unveiling independent artists who are not
            afforded the attention they deserve. Our mission is to curate events
            that do just that! Keep an eye on our page for upcoming events in
            Melbourne, Sydney, New York, Nicosia, Athens and who knows where
            else?!
          </h3>
        </div>
          ...
          <div className={bodyStyles.on}>
            <div className={bodyStyles.digitalevents}>
              ...
              <div className={bodyStyles.column1}>
                {documentToReactComponents(
                  data.contentfulEvent.whatsOnDescription1.json
                )}
            ...
            <div className={bodyStyles.artistsupport}>
              ...
              <div className={bodyStyles.column2}>
                {documentToReactComponents(
                  data.contentfulEvent.whatsOnDescription2.json
                )}
        ...
        <div className={bodyStyles.stream}>
          ...
          <div
            className={
              data.contentfulEvent.showhideVideo
                ? bodyStyles.videoNO
                : bodyStyles.videoYES
            }
            data-sal="slide-up"
      ...
      <div className={bodyStyles.body}>
        <div className={bodyStyles.featured}>
          ...
          <h3>
            The financial crisis in Europe has led Greece to emerge as a hub of
            creativity and innovative thinking. The Greek Fringe is a movement
            that seeks to expose Greece and its booming arts scene and thrust
            attention upon diasporic art throughout the Globe.{" "}
          </h3>
          <ArtistFeatured />
      ...
      <div className={bodyStyles.body}>
        ...
        <div id="callout" className={bodyStyles.callout}>
          ...
          <div className={bodyStyles.callouttxt}>
            ...
            <p>
              <h3>
                We’re after work that represents the experience of modern
                Hellenic diversity from emerging artists and creatives living
                and working in Sydney and Melbourne. We also wish to extend this
                callout to artists living abroad whose work can be included in a
                digital capacity.
              </h3>
            </p>
            <p>
              <h3>
                Our curatorial ethos is broad and inclusive and we’re open to
                all types of media.
              </h3>
            </p>
          </div>
          ...
          <div className={bodyStyles.preferenceto}>
            ...
            <div className={bodyStyles.howtoapply}>
              <h5>How to apply</h5>
              <p>
                Make sure your work is a good fit for our platform (and that
                we’re a good fit for you). Take a look at our <b>About</b>{" "}
                section to get a feel for what we do.
              </p>
      ...
      <div className={bodyStyles.body}>
        <div className={bodyStyles.about}>
          ...
          <div className={bodyStyles.abouttxt}>
            <div className={bodyStyles.abouttxt1}>
              <div className={bodyStyles.textWithLines}>OUR VISION</div>
              <p>
                It is time for the celebration of Greece, its people, history
                and art to shift to a new level. The Greek Fringe will attract
                talent that represents the experience of the modern Hellenic
                diversity. The Greek Fringe will shift beyond the folkloric
                representation of migration to explore the contemporary Hellenic
                diaspora throughout the Globe and the dynamic arts scene of
                mother Greece.
              </p>
            </div>

            <div className={bodyStyles.abouttxt2}>
              <div className={bodyStyles.textWithLines}>CLAIMING THE NOW</div>
              <div>
                <p>
                  The financial crisis in Europe has led Greece to emerge as a
                  hub of creativity and innovative thinking. The Greek Fringe
                  seeks to promote and celebrate contemporary culture, which can
                  often be overshadowed by a glorified notion of the past.
                </p>
                <p>
                  The Greek Fringe is a movement that will expose Greece and its
                  booming arts scene and promote diasporic art across various
                  forms of media. Though the theme is Greek, the festival aims
                  to attract people who appreciate contemporary art and culture,
                  regardless of their heritage.
                </p>
                <p>
                  As humans evolve, so too does language, culture and influence.
                  If we don’t engage with the evolving artscape of Greece and
                  communities abroad, the risk is that Greek culture can become
                  stagnant and obsolete. We are here to facilitate new and
                  emerging interpretations of Greek culture. There is an
                  appetite among younger generations of the diaspora to explore
                  and connect with not only the Greece of their Grandparents but
                  the Greece of now.
                </p>
          ...
          <div className={bodyStyles.team}>
            ...
            <div>
              ...
              <p>
                Founder of Sydney Greek Jam, Christina is big on community
                engagement and providing a platform for underrepresented
                artists. This concept was the genesis for Greek Fringe and
                exposing hidden talents is what gives her a real buzz. She is an
                innovative coordinator of projects and people and has worked on
                a stack of indie events, including the Melbourne Rebetiko
                Festival. She plays percussion in a rebetiko band and strums the
                tzoura strictly in the confines of her loungeroom (much to her
                dog’s torment).
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                in Sydney. Taking a lead on literature, he will shed light on
                burgeoning writers in the Greek scene and conduct interviews
                with our featured artists. Michael runs the blog Amnesiac
                Archive, which is dedicated to research into music and recorded
                sound, and Cycladic Press, which publishes books and zines on
            ...
            <div>
              <div className={bodyStyles.teamtitle}>
                <a href="https://www.instagram.com/nikoplaskas/"></a>
                <h3
                  data-sal="slide-up"
                  data-sal-delay="300"
                  data-sal-duration="700"
              ...
              <p>
                Niko Plaskasovitis is an emerging artist and creative producer
                who lives and works on Gadigal Land. He’s responsible for the
                editing of all the slick videos you see on our site. You’ll
                occasionally find him mixing music in intimate settings or
                experimenting with sweet ingredients for a cake conspiracy. Niko
                is currently completing his Bachelor of Media Art at UNSW Art
                and Design.
              </p>
            </div>
        ...
        <div className={bodyStyles.support}>
          ...
          <p>
            <h3>
              We LURVE our sponsors! They are the force that enables us to shed
              light on the obscure, the underrepresented and the mega-talented.
              Its thanks to them that we can explore what contemporary Hellenic
              culture can bring to the table beyond cuisine.
            </h3>
          </p>
          <p>
            <h3>If this strikes a chord with you, get on board and…</h3>
          </p>

          <div
            className={bodyStyles.supportbtn}
            data-sal="slide-up"
            data-sal-delay="300"
            data-sal-duration="800"
            data-sal-easing="ease"
          >
            <a
              href="https://www.patreon.com/greekfringefest"
              target="_blank"
              rel="noreferrer"
            >
              <button
